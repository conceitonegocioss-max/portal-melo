...
const ROUTES = {
  ...
  MATERIAIS_CONSULTAS: "/colaborador/auditoria/materiais-consultas",
};
      ...
      <div className="container auditoriaPage">
            ...
            <div className="govDetailsGrid">
              <div className="govBox">
                ...
                <div className="tableWrap" role="region" aria-label="Perfis Administrativos do Portal">
                  <table className="tbl"><thead><tr><th>Perfil</th><th>Finalidade</th><th>Capacidade</th></tr></thead><tbody><tr><td className="mono">ADMIN_GESTOR</td><td>Diretrizes e governança</td><td>Não operacional</td></tr><tr><td className="mono">ADMIN_COMPLIANCE</td><td>Operação e registro de evidências</td><td>Operacional</td></tr><tr><td className="mono">ADMIN_AUDITORIA</td><td>Verificação e acompanhamento técnico</td><td>Somente leitura</td></tr><tr><td className="mono">COLABORADOR</td><td>Usuário final</td><td>Treinamentos, provas e termos</td></tr></tbody></table>
                </div>
              ...
              <div className="govBox">
                ...
                <div className="tableWrap" role="region" aria-label="Distribuição Atual de Perfis">
                  <table className="tbl"><thead><tr><th>Pessoa</th><th>Perfil</th><th>Função</th></tr></thead><tbody><tr><td>Micaele da Silva Melo</td><td className="mono">ADMIN_GESTOR</td><td>Governança e decisão estratégica</td></tr><tr><td>Thaise Morais da Silva</td><td className="mono">ADMIN_COMPLIANCE</td><td>Execução e registro de evidências</td></tr><tr><td>Cynthia Mylena Lopes de Andrade</td><td className="mono">ADMIN_COMPLIANCE</td><td>Execução e registro de evidências</td></tr><tr><td>Wantuiller de Oliveira Trindade</td><td className="mono">ADMIN_AUDITORIA</td><td>Verificação técnica, sem poder operacional</td></tr></tbody></table>
                </div>
        ...
        <div className="areaBlock">
          ...
          <div className="adminGrid">
            ...
            <AdminCard icon="📚" title="Consultas a Materiais & Políticas" text="Relatório de ciência geral da biblioteca e consultas/baixos dos documentos pelos colaboradores." href={ROUTES.MATERIAIS_CONSULTAS} button="Abrir Controle" tone="yellow" />
          </div>
        </div>
        ...
        <style jsx global>{`
          .auditoriaPage{max-width:1280px}.adminHeader{margin-bottom:14px}.adminTitle{margin:0;font-size:30px;font-weight:900;color:#0b1f3a}.adminDesc{margin:10px 0 0;max-width:920px;font-size:13px;font-weight:750;color:rgba(0,0,0,.65);line-height:1.45}.areaBlock{margin-top:18px}.areaTitle{margin:0 0 10px;font-size:14px;font-weight:950;color:#0a2a6a;text-transform:uppercase;letter-spacing:.04em}.adminGrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;align-items:stretch}.adminCard{position:relative;z-index:1;padding:16px!important;border-radius:18px!important;background:#fff!important;border:1px solid rgba(10,42,106,.1)!important;box-shadow:0 12px 28px rgba(15,23,42,.06)!important;display:flex;flex-direction:column;min-height:150px}.govCard{margin-top:16px;min-height:auto}.govCard.expanded{z-index:20}.adminCardHead{display:flex;gap:10px;align-items:flex-start}.adminIcon{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:rgba(11,79,217,.08);border:1px solid rgba(11,79,217,.12);flex:0 0 auto}.adminCardHeadText{width:100%}.adminCardTitleRow{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.adminCardTitle{font-weight:900;font-size:16px;margin:0;color:#0b1f3a}.adminCardText{margin-top:4px;font-size:13px;font-weight:650;color:rgba(0,0,0,.72);line-height:1.35}.adminCardActions{margin-top:auto;padding-top:12px}.miniBtn{border:1px solid rgba(10,42,106,.14);background:rgba(255,255,255,.9);padding:8px 10px;border-radius:999px;font-size:12px;font-weight:900;color:#0a2a6a;cursor:pointer;white-space:nowrap}.govDetailsGrid{margin-top:12px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.govCollapsedHint{margin-top:12px;font-size:12px;font-weight:800;opacity:.7}.govBox{border-radius:16px;border:1px solid rgba(10,42,106,.12);background:linear-gradient(180deg,#fff,#f7f9ff);padding:12px}.govBoxTitle{font-weight:900;font-size:13px;margin-bottom:10px;color:#0b1f3a}.govNote,.govHint{margin-top:10px;font-size:12px;font-weight:800;color:rgba(0,0,0,.65)}.govNote{border-top:1px dashed rgba(10,42,106,.18);padding-top:10px}.tableWrap{width:100%;overflow:visible;border-radius:14px;border:1px solid rgba(10,42,106,.08);background:#fff}.tbl{width:100%;border-collapse:collapse;table-layout:fixed}.tbl th,.tbl td{border-bottom:1px solid rgba(10,42,106,.08);padding:10px;text-align:left;font-size:12px;font-weight:700;color:rgba(0,0,0,.75);vertical-align:top;word-break:break-word}.tbl th{font-weight:900;color:#0a2a6a;background:rgba(11,79,217,.05)}.mono{font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,"Liberation Mono","Courier New",monospace;font-weight:900;color:#0a2a6a;word-break:break-word}@media(max-width:980px){.adminGrid,.govDetailsGrid{grid-template-columns:1fr}.tableWrap{overflow-x:auto}.tbl{min-width:620px;table-layout:auto}}
        `}</style>
      </div>
    </main>
  );
